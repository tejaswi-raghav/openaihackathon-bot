...
const translations = {
  ...
  hi: {
    ...
    casesAction: "मेरे सहेजे आवेदन",
    casesBody: "इस फ़ोन पर सहेजे ड्राफ्ट, तारीख और अगला कदम देखें।",
    stateAction: "मेरा राज्य पोर्टल खोजें",
...
function applyTheme(theme) {
  ...
  if (btn) {
    btn.innerHTML = THEME_ICONS[theme === "dark" ? "light" : "dark"];
    btn.setAttribute("aria-label", theme === "dark" ? "Switch to light theme" : "Switch to dark theme");
  }
  try { localStorage.setItem("rti-theme", theme); } catch {}
  window.dispatchEvent(new CustomEvent("rti-saathi:theme", { detail: { theme } }));
}
